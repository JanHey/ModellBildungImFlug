...
Version: X1 (Stand: 17.05.2023 = erste Version für den dritten Zyklus)
...
def vorbereitungen(dateiname_realvideo, B):
    ...
    N_Bilder, fps = video_in_bilder_zerlegen(dateiname_realvideo)
...
def video_in_bilder_zerlegen(dateiname_realvideo):
    """
...
def erzeuge_Ueberlagerungsvideo(Nr):
    ...
    print("Du findest das Video mit dem Dateinamen > " + dateiname_video + ".mp4 <" + " in dem Unterordner mit eurem Gruppennamen. Schaut es euch einmal an!")
